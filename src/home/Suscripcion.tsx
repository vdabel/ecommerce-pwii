...
const Suscripcion = () => {
  return (
    <section className="flex flex-col justify-center items-center font-(family-name:--font-secondary)">
      ...
      <div className="flex flex-row ">
        <input type="checkbox" />
        <label htmlFor="">I agree that my submitted data is being collected and stored.</label>
      </div>
    </section>
  )
}
